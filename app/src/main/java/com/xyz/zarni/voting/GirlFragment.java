...
public class GirlFragment extends Fragment implements View.OnClickListener {
    ...
    private DatabaseReference mGirls;
    private ImageView p1, p2, p3, p4, p5, p6, p7, p8, p9;
    private MMTextView hhw, mms, nzt, tzlp, mcm, zpp, mas, spn, mppw;
    ...
    private DatabaseReference mUsers, fVote;
    private Users users;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_girl, container, false);
        ...
        mGirls = FirebaseDatabase.getInstance().getReference().child("Girls");
        mGirls.keepSynced(true);
...
//        p9 = (ImageView) v.findViewById(R.id.p9);
        ...
        hhw = (MMTextView) v.findViewById(R.id.hhw);
        mms = (MMTextView) v.findViewById(R.id.mms);
        nzt = (MMTextView) v.findViewById(R.id.nzt);
        tzlp = (MMTextView) v.findViewById(R.id.tzlp);
        mcm = (MMTextView) v.findViewById(R.id.mcm);
        zpp = (MMTextView) v.findViewById(R.id.zpp);
        mas = (MMTextView) v.findViewById(R.id.mas);
//        spn = (MMTextView) v.findViewById(R.id.spn);
//        mppw = (MMTextView) v.findViewById(R.id.mppw);
...
//        vo9 = (Button) v.findViewById(R.id.vo9);
        ...
        mGirls.child("1").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    model1 = dataSnapshot.getValue(Model.class);

                    hhw.setMMText(model1.getName());
        ...
        mGirls.child("2").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    model2 = dataSnapshot.getValue(Model.class);

                    mms.setMMText(model2.getName());
        ...
        mGirls.child("3").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    model3 = dataSnapshot.getValue(Model.class);

                    nzt.setMMText(model3.getName());
        ...
        mGirls.child("4").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    model4 = dataSnapshot.getValue(Model.class);

                    tzlp.setMMText(model4.getName());
        ...
        mGirls.child("5").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    model5 = dataSnapshot.getValue(Model.class);

                    mcm.setMMText(model5.getName());
        ...
        mGirls.child("6").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    model6 = dataSnapshot.getValue(Model.class);

                    zpp.setMMText(model6.getName());
        ...
        mGirls.child("7").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    model7 = dataSnapshot.getValue(Model.class);

                    mas.setMMText(model7.getName());
...
//        mGirls.child("8").addValueEventListener(new ValueEventListener() {
//            @Override
//            public void onDataChange(DataSnapshot dataSnapshot) {
//                if (dataSnapshot.exists()) {
//                    model8 = dataSnapshot.getValue(Model.class);
//
//                    spn.setMMText(model8.getName());
...
//        });
//
//        mGirls.child("9").addValueEventListener(new ValueEventListener() {
//            @Override
//            public void onDataChange(DataSnapshot dataSnapshot) {
//                if (dataSnapshot.exists()) {
//                    model9 = dataSnapshot.getValue(Model.class);
//
//                    mppw.setMMText(model9.getName());
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.v1:
                ...
                i.putExtra("image_one", model1.getImage_one());
                i.putExtra("image_two", model1.getImage_two());
                i.putExtra("image_three", model1.getImage_three());
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if (dataSnapshot.exists()) {
                                ...
                                if (users.getPermission().equals("not_allowed")) {
                                    ...
                                    if (sharedPreferences.getString("Queen", "").equals("yes")) {
                                        ...
                                        builder.setTitle(MDetect.INSTANCE.getText("သတိပေးချက်"))
                                                ...
                                                .setPositiveButton(MDetect.INSTANCE.getText("သေချာပါပြီ"), new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        ...
                                                        editor.commit();
                                                        editor.putString("voted_queen",model1.getName());
                                                        editor.commit();
                                                        fVote.child("1").addValueEventListener(new ValueEventListener() {
                                                            @Override
                                                            public void onDataChange(DataSnapshot dataSnapshot) {

                                                                fVote.child("1").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue("Vote");
                                        ...
                                        builder.setTitle(MDetect.INSTANCE.getText("သတိပေးချက်"))
                                                ...
                                                .setPositiveButton(MDetect.INSTANCE.getText("သေချာပါပြီ"), new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        ...
                                                        editor.putString("Queen", "yes");
                                                        editor.commit();
                                                        editor.putString("voted_queen",model2.getName());
                                                        editor.commit();
                                                        fVote.child("2").addValueEventListener(new ValueEventListener() {
                                                            @Override
                                                            public void onDataChange(DataSnapshot dataSnapshot) {

                                                                fVote.child("2").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue("Vote");
                                        ...
                                        builder.setTitle(MDetect.INSTANCE.getText("သတိပေးချက်"))
                                                ...
                                                .setPositiveButton(MDetect.INSTANCE.getText("သေချာပါပြီ"), new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        ...
                                                        editor.putString("Queen", "yes");
                                                        editor.commit();
                                                        editor.putString("voted_queen",model3.getName());
                                                        editor.commit();
                                                        fVote.child("3").addValueEventListener(new ValueEventListener() {
                                                            @Override
                                                            public void onDataChange(DataSnapshot dataSnapshot) {

                                                                fVote.child("3").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue("Vote");
                                        ...
                                        builder.setTitle(MDetect.INSTANCE.getText("သတိပေးချက်"))
                                                ...
                                                .setPositiveButton(MDetect.INSTANCE.getText("သေချာပါပြီ"), new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        ...
                                                        editor.putString("Queen", "yes");
                                                        editor.commit();
                                                        editor.putString("voted_queen",model4.getName());
                                                        editor.commit();
                                                        fVote.child("4").addValueEventListener(new ValueEventListener() {
                                                            @Override
                                                            public void onDataChange(DataSnapshot dataSnapshot) {

                                                                fVote.child("4").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue("Vote");
                                        ...
                                        builder.setTitle(MDetect.INSTANCE.getText("သတိပေးချက်"))
                                                ...
                                                .setPositiveButton(MDetect.INSTANCE.getText("သေချာပါပြီ"), new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        ...
                                                        editor.putString("Queen", "yes");
                                                        editor.commit();
                                                        editor.putString("voted_queen",model5.getName());
                                                        editor.commit();
                                                        fVote.child("5").addValueEventListener(new ValueEventListener() {
                                                            @Override
                                                            public void onDataChange(DataSnapshot dataSnapshot) {

                                                                fVote.child("5").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue("Vote");
                                        ...
                                        builder.setTitle(MDetect.INSTANCE.getText("သတိပေးချက်"))
                                                ...
                                                .setPositiveButton(MDetect.INSTANCE.getText("သေချာပါပြီ"), new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        ...
                                                        editor.putString("Queen", "yes");
                                                        editor.commit();
                                                        editor.putString("voted_queen",model6.getName());
                                                        editor.commit();
                                                        fVote.child("6").addValueEventListener(new ValueEventListener() {
                                                            @Override
                                                            public void onDataChange(DataSnapshot dataSnapshot) {

                                                                fVote.child("6").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue("Vote");
                                        ...
                                        builder.setTitle(MDetect.INSTANCE.getText("သတိပေးချက်"))
                                                ...
                                                .setPositiveButton(MDetect.INSTANCE.getText("သေချာပါပြီ"), new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        ...
                                                        editor.putString("Queen", "yes");
                                                        editor.commit();
                                                        editor.putString("voted_queen",model7.getName());
                                                        editor.commit();
                                                        fVote.child("7").addValueEventListener(new ValueEventListener() {
                                                            @Override
                                                            public void onDataChange(DataSnapshot dataSnapshot) {

                                                                fVote.child("7").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue("Vote");
...
//                                                        editor.putString("Queen", "yes");
//                                                        editor.commit();
//                                                        fVote.child("8").addValueEventListener(new ValueEventListener() {
//                                                            @Override
//                                                            public void onDataChange(DataSnapshot dataSnapshot) {
//
//                                                                fVote.child("8").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue("Vote");
...
//                                                        editor.putString("Queen", "yes");
//                                                        editor.commit();
//                                                        fVote.child("9").addValueEventListener(new ValueEventListener() {
//                                                            @Override
//                                                            public void onDataChange(DataSnapshot dataSnapshot) {
//
//                                                                fVote.child("9").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue("Vote");
